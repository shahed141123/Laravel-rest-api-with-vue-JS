    ...
    <section class="content-header mt-3">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
           <a href="{{route('news-post.index')}}" class="btn btn-secondary float-right" data-toggle="tooltip" data-placement="bottom" title="news-post List">
            <i class="fas fa-eye"></i>News List</a>
      ...
      <div class="row">
        <div class="col-md-12">
           <div class="card">
            ...
            <form method="post" action="{{route('news-post.update',$post->id)}}">
                @csrf
                 @method('PATCH')
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <label for="mytextarea1" class="col-form-label">Bulletin <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-4">
                        <label for="mytextarea2" class="col-form-label">News Description</label>
                    ...
                    <div class="mb-4">
                        <label for="post_cat_id">News Category <span class="text-danger">*</span></label>
                        ...
                        <div class="mb-4">
                          ...
                          <select name="condition" class="form-control">
                              <option value="normal" {{(($post->condition=='normal')? 'selected' : '')}}>Normal</option>
                              <option value="top" {{(($post->condition=='top')? 'selected' : '')}}>Top News</option>
                              <option value="featured" {{(($post->condition=='featured')? 'selected' : '')}}>Featured News</option>
                              <option value="viewed" {{(($post->condition=='viewed')? 'selected' : '')}}>Most Viewed</option>
                              <option value="popular" {{(($post->condition=='popular')? 'selected' : '')}}>Popular</option>
                              <option value="special" {{(($post->condition=='special')? 'selected' : '')}}>Special Day Related News</option>
                              <option value="breaking" {{(($post->condition=='breaking')? 'selected' : '')}}>Breaking News</option>
