...
<div class="content-wrapper">
    ...
    <section class="content-header mt-3 mb-3">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
           <a href="{{route('news-post.index')}}" class="btn btn-primary float-right rounded-pill" data-toggle="tooltip" data-placement="bottom" title="Add User">
            <i class="bx bx-eye"></i>News List</a>
    ...
    <div class="card-body">
      <form method="post" action="{{route('news-post.store')}}">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
          <label for="cat_id">News Category <span class="text-danger">*</span></label>
        ...
        <div class="mb-4">
          <label for="inputPhoto" class="col-form-label">News Header Photo <span class="text-danger">*</span></label>
        ...
        <div class="mb-4">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="special">Special Day Related News</option>
