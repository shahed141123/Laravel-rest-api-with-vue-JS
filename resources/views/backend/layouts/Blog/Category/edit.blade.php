    ...
    <section class="content-header mt-3">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-3">
           <a href="{{route('blog-category.index')}}" class="btn btn-secondary float-right" data-toggle="tooltip" data-placement="bottom" title="Add User">
            <i class="bx bx-eye"></i>Blog Category List</a>
    ...
    <section class="content">
        <div class="card">
             <div class="card-header bg-dark" >
                <h5 class="card-title text-center" style="float: none">Blog Category Edit Form</h5>
             </div>
            <div class="card-body">
