        ...
        <div class="col-md-12">
           <div class="card">
              <div class="card-header bg-dark" >
                <h3 class="card-title text-center" style="float: none">Terms & Conditions Form</h3>
        ...
        <form method="post" action="{{route('terms.store')}}">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="summernote">Terms & Conditions Description</label>
                    <textarea id="description" name="terms">{{old('description')}}</textarea>
                     @error('terms')
